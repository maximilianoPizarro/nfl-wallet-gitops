...
The catalog uses east domain `cluster-4cspb.4cspb.sandbox1414.opentlc.com` in URLs. West: `cluster-4q4c7.4q4c7.sandbox3802.opentlc.com`. Update `servers` URLs and `backstage.io/view-url` annotations if your cluster domains differ.
