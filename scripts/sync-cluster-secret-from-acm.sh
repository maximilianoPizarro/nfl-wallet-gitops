...
case "$CLUSTER" in
  east) DEFAULT_SERVER="https://api.cluster-s6krm.s6krm.sandbox3480.opentlc.com:6443" ;;
  west) DEFAULT_SERVER="https://api.cluster-9nvg4.dynamic.redhatworkshops.io:6443" ;;
