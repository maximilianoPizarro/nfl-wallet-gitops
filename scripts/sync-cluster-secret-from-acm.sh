...
case "$CLUSTER" in
  east) DEFAULT_SERVER="https://api.cluster-thmg4.thmg4.sandbox4076.opentlc.com:6443" ;;
  west) DEFAULT_SERVER="https://api.cluster-2tjvj.2tjvj.sandbox5367.opentlc.com:6443" ;;
