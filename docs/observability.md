...
The Route host in each environment follows the pattern **`nfl-wallet-<env>.apps.<cluster-domain>`** (e.g. prod: `nfl-wallet-prod.apps.cluster-64k4b.64k4b.sandbox5146.opentlc.com`).
...
```bash
export CLUSTER_DOMAIN="cluster-64k4b.64k4b.sandbox5146.opentlc.com"
...
```bash
export GATEWAY_HOST="nfl-wallet-dev.apps.cluster-64k4b.64k4b.sandbox5146.opentlc.com"
...
```bash
export GATEWAY_HOST="nfl-wallet-test.apps.cluster-64k4b.64k4b.sandbox5146.opentlc.com"
