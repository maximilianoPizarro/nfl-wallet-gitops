...
curl https://nfl-wallet-prod.apps.cluster-thmg4.thmg4.sandbox4076.opentlc.com/

# Prod - API (key required)
curl -H "X-Api-Key: nfl-wallet-customers-key" https://nfl-wallet-prod.apps.cluster-thmg4.thmg4.sandbox4076.opentlc.com/api-customers/Customers
```
...
Default: `cluster-thmg4.thmg4.sandbox4076.opentlc.com`. To change, edit the patches in each overlay.
